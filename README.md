...
- [docs/09-kassenbuch.md](docs/09-kassenbuch.md): Kassenfunktion als zuschaltbares Modul statt als Pflicht. Warum die offene Ladenkasse zulässig ist, wie die zwei Betriebsmodi aussehen, und warum die geplante Registrierkassenpflicht ab 2028 den Zeitplan bestimmt.
