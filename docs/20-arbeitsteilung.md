...
| C8 | Webhooks | läuft | — | Reiter in „Schnittstellen", mit Zustellprotokoll und Grund der Stilllegung an der Zeile |
| C9 | Maschinenzugänge, Channel Manager | läuft | — | Zwei Reiter. Geheimnis einmal, mit ausdrücklicher Bestätigung |
| C10 | Benutzer und Rollen | läuft | — | Reiter. Brauchte drei Endpunkte (`users`, `roles`, Rollen setzen). Benutzer **anlegen** gehört zur Einladung und ist nicht dabei |
